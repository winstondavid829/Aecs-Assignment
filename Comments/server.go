...
func main() {
	...
	// // Create UserHandler
	commitHandlerV1 := handlers.NewIssueCommentsHandler(loggerUserRegistry)
	...
	PostUserRegistry.HandleFunc("/v1/fetch/issue/comments", commitHandlerV1.FetchGithub_IssueCommentHandlerV1)
